...
function calculo(){
    ...
    //let suma=carro.reduce((suma,value)=>{return suma+value.cantidadCarro},0) alternativa con reduce
    let suma=0;
    for (let i in carro){
        suma+=carro[i].cantidadCarro
    }
...
const aplicarDescuento=document.querySelector("#boton-descuento").addEventListener("click",()=>{descuento()})



//leer vaciarCarro

const vaciar=document.querySelector("#boton-vaciarCarro").addEventListener("click",()=>{vaciarCarro()})
